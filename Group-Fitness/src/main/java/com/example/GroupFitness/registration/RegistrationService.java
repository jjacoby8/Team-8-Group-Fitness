package com.example.GroupFitness.registration;
...
import com.example.GroupFitness.entity.MemberService;
...
public class RegistrationService {
    ...
    public String register (RegistrationRequest request) {
        ...
        if (!isValidEmail){
            String invalidEmail = String.format("%s is not a valid email address",request.getEmail());
            throw new IllegalStateException(invalidEmail);
        }
